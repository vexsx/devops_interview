...
### 1. **What is Kubernetes?**  <!-- Priority #6 -->
...
### 2. **What are the Core Components of Kubernetes?**  <!-- Priority #6 -->
...
### 3. **Is `kubelet` started on all nodes?**  <!-- Priority #5 -->
...
### 4. **Who checks the probes of the Pod?**  <!-- Priority #5 -->
...
### 5. **What is the Kubernetes Control Plane?**  <!-- Priority #6 -->
...
### 6. **How does the `kubelet` communicate with the controller?**  <!-- Priority #5 -->
...
### 7. **How Does Kubernetes Process a Request?**  <!-- Priority #5 -->
...
### 8. **How Does Kubernetes Handle Authentication and Authorization?**  <!-- Priority #5 -->
...
### 9. **How Does Communication Happen in Kubernetes?**  <!-- Priority #6 -->
...
### 14. **When NAT Happens in Kubernetes**  <!-- Priority #5 -->
...
### 15. **How Does a Service Work?**  <!-- Priority #5 -->
...
### 16. **Design Goals Behind Kubernetes Service Implementation**  <!-- Priority #5 -->
...
### 17. **Define a scenario where scaling CoreDNS makes response latency higher than before**  <!-- Priority #4 -->
